...
class CompetitionEditor(qt.QDialog):
    def __init__(self, main_window, db):
        ...
        # make calendars side by side
        self.group_calendars = qt.QGroupBox()
        self.group_calendars_layout = qt.QGridLayout()
        self.group_calendars.setLayout(self.group_calendars_layout)
        self.group_calendars_layout.addWidget(self.label_competition_event_date,0,0)
        self.group_calendars_layout.addWidget(self.calendar_competition_event,1,0)
        self.group_calendars_layout.addWidget(self.label_competition_deadline,0,1)
        self.group_calendars_layout.addWidget(self.calendar_competition_deadline,1,1)
        self.layout.addWidget(self.group_calendars)
